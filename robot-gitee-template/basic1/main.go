...
import (
	...
	framework "github.com/opensourceways/community-robot-lib/robot-gitee-framework1"
...
func main() {
	...
	s.RegisterIssueHandler(r.handleIssueEvent)
	s.RegisterPullRequestHandler(r.handlePREvent)
